                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3">
                                    ...
                                    <div class="col-12 col-md-3">
                                        ...
                                        <input type="number" name="nohp" placeholder="No Hp / Telepon Aktif"
                    ...
                    <div class="col-12 my-4">
                        <div class="card shadow rounded-4">
                            <div class="card-body">
                                ...
                                <form class="row g-3">
                                    <div class="col-12">
                                        <label for="nama_universitas" class="form-label">Nama Universitas (S1/D3)</label>
                                    ...
                                    <div class="col-12 col-lg-6">
                                        <label for="organiasi_diikuti" class="form-label">Organisasi yang pernah diikuti</label>
                                        <input type="text" name="organiasi_diikuti" class="form-control" id="organiasi_diikuti">
                                    </div>
                                    <div class="col-12 col-lg-6">
                                        <label for="tahun_organisasi" class="form-label">Tahun</label>
                                        <input type="text" name="tahun_organisasi" class="form-control" id="tahun_organisasi">
                                    </div>
                                    <div class="col-12">
                                        <label for="jabatan_organisasi" class="form-label">Jabatan</label>
                                        <input type="text" name="jabatan_organisasi" class="form-control" id="jabatan_organisasi">
                                    </div>
                                    <div class="col-12">
                        ...
                        <div class="card shadow rounded-4">
                            <div class="card-body">
                                ...
                                <form class="row g-3" action="#">
                                    ...
                                    <div class="col-12">
                                        <label for="riwayat_atasan_bawahan" class="form-label">Sebutkan siapa yang  pernah menjadi atasan/bawahan anda saat itu?</label>
                                        <textarea class="form-control" name="riwayat_atasan_bawahan" id="riwayat_atasan_bawahan" cols="10"
                                        rows="2"></textarea>
                                        <div id="riwayat_atasan_bawahan" class="form-text">Atasan : 3 orang, bapak a, bapal b, ibu c / Bawahan : 5 orang, mas d, mba e, dst.</div>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-12 my-4">
                        <div class="card shadow rounded-4">
                            <div class="card-body">
                                ...
                                <form class="row g-3">
                                    <div class="col-12">
                                        <label for="alasan_ingin_bekerja_diperusahaan" class="form-label">Mengapa anda ingin bekerja di perusahaan kami?</label>
                                        <input type="text" name="alasan_ingin_bekerja_diperusahaan" class="form-control" id="alasan_ingin_bekerja_diperusahaan">
                                    </div>
                                    <div class="col-12">
                                        <label for="harapan_gaji" class="form-label">Berapa gaji yang anda harapkan?</label>
                                        <input type="text" name="harapan_gaji" class="form-control" id="harapan_gaji">
                                    </div>
                                    <div class="col-12">
                                        <label for="fasilitas_tambahan" class="form-label">Apakah ada fasilitas tambahan yang anda inginkan?</label>
                                        <input type="text" name="fasilitas_tambahan" class="form-control" id="fasilitas_tambahan">
                                    </div>
                                    <div class="col-12">
                                        <label for="kesiapan_mulai_bekerja" class="form-label">Kapan anda dapat mulai bekerja?</label>
                                        <input type="text" name="kesiapan_mulai_bekerja" class="form-control" id="kesiapan_mulai_bekerja">
                                    </div>
                                    <div class="col-12">
                                        <label for="kenalan_didalam_perusahaan" class="form-label">Adakah kenalan anda di perusahaan kami?</label>
                                        <input type="text" name="kenalan_didalam_perusahaan" class="form-control" id="kenalan_didalam_perusahaan">
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-12 my-4">
                        <div class="card shadow rounded-4">
                            <div class="card-body">
                                ...
                                <form action="#">
                                    <div class="mb-3">
                                        <label for="formFile" class="form-label">Silahkan upload CV anda melalui link dibawah ini</label>
